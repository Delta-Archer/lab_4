...
namespace Lab_4.Models
{
    public class CourseDbInitializer : DropCreateDatabaseAlways<StudentsContext>
    {
        ...
        {
            Student s1 = new Student { Id = 1, Name = "Єгор", Surname = "Іванов" };
            Student s2 = new Student { Id = 2, Name = "Марія", Surname = "Васильєва" };
            Student s3 = new Student { Id = 3, Name = "Олег", Surname = "Кузнєцов" };
